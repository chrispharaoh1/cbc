...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="EngineerIndex.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="EngineerIndex.php">
...
";
     ...
     while($row0 = $query_result->fetch_assoc()){
        ...
        if($row0['recieve_note'] == "" && $row0['delivery_note'] !== ""){
...
?>
                            ...
                            <a class="dropdown-item text-center small text-gray-500" href="Engineer_notification.php">Show All Alerts</a>       <!-- Dropdown - Alerts -->
                    ...
                    <tbody>
                        ...
                        <tr style='margin-left:50%;margin-right:50%;'>
                            <td colspan='5' > 
                                ...
                                <a href='Delivery_note.php?order=".$row["requisition_number"]."&id=$id1' class='btn btn-info'>Delivery note</a>
              ...
              <div class='modal-dialog'>
                <div class='modal-content'>
                  ...
                  <div class='modal-footer'>
                    ...
                    <a href='confirm_delivery.php?order=".$row["requisition_number"]."&id=$id' class='btn btn-primary'>Confirm</a>
                  </div>
                </div>
...
?>
               ...
               <?php 
                    ...
                    $query = "SELECT * FROM `orders` WHERE status < 5 AND projectCode='$pg'";
                ...
                <div class='table-responsive'>
                 <table class='table table-bordered' id='dataTable' width='90%' cellspacing='0'>
                    ...
                    <tbody>
                        ...
                        <tr style='margin-left:50%;margin-right:50%;'>
                            <td colspan='5' > 
                                <a href='Goods_recieved_note.php?order=".$row["requisition_number"]."'   class='btn btn-primary'>Goods recieved note</a>
