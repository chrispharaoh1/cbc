...
<head>
    ...
    <script>
        function showHide(){
            ...
            var buttn = document.getElementById("table");
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="Add_project.php">   
                            <td> <button name="submit"  class="btn btn-primary"><i class="fas fa-plus"></i>&#160 Create new project</button></td>  
                        </a>  
                            ...
                            <div class='card border-left-primary shadow h-100 py-2'>
                                <div class='card-body'>
                                    <div class='row no-gutters align-items-center'>
                                        <div class='col mr-2'>
                                            <!-- <i class='far fa-folder-open' id='folder'></i> -->
                                            <a href='Project_index.php?id=$row[id]'>
                                                <img id='folder'src='img/folder.png' alt='folder'></img>
                                                <div class='h5 mb-0 font-weight-bold text-gray-800' style='text-align:center'> ".$row["projectName"]."</div>
                                                </a>    
                                        </div>
                                    </div>
                                </div>
