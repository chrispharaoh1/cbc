    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <form  method="POST" action="Foreman_send_request.php">
                ...
                <input type="number" style="text-align: center !important" class="form-control form-control-user"
                id="exampleInputPassword" placeholder="B No. <?php echo $req_order?>" disabled></input>
                ...
                id="exampleInputPassword" name="date_required" placeholder="Date"></input>
                </div>
