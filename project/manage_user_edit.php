<?php 
    ...
    elseif(isset($_POST['submit'])){
        ...
        $id = $_GET["id"];
        $checkBox = isset($_POST["checkb"]);

        //checking if password check box is checked
    ...
    if(count($errors) == 0){
        ...
        if(!empty($fname) && !empty($lname)  && !empty($employmentID) && !empty($phoneNumber) && !empty($userName) && !empty($password1) && !empty($password2) && !empty($role)){
            if($password1 == $password2){
                ...
                $query = "UPDATE employee SET employeeNumber='$employmentID', firstName='$fname', lastName='$lname', phoneNumber='$phoneNumber', email='$email', role ='$role1', user_name='$userName', password='$pasword_hash'  WHERE  id ='$id'";
        ...
        //if checkbox is not checked
            ...
            if(!empty($fname) && !empty($lname)  && !empty($employmentID) && !empty($phoneNumber) && !empty($userName) && !empty($role)){
 ...
 <div class="card shadow mb-4" style="width:100%">
    ...
    <div class="p-5">
        ...
        <form class="user" method="post" id="formId">
            ...
            <input type="checkbox" id="passcheck" name="checkb" onChange="showHide(this.checked)" class="passcheck" value="editpass">
            <label for="password"> Change password too?</label><br>
            <div class="form-group row" id="passshow">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="password" style="display:none" id="pass1" value="<?php echo $password1;?>" name="pass1" class="form-control form-control-user"
                        id="exampleInputPassword" placeholder="Password" >
                </div>
                
                <div class="col-sm-6">
                    <input type="password" style="display:none" id="pass2" name="pass2" value="<?php echo $password2;?>" class="form-control form-control-user"
